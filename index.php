...
<html lang="pl">
   ...
   <body>
      ...
      <div  class="container-fluid bg-1 text-center">
         <h1 class="title">Agnieszka Machałowska</h1>
      ...
      <div id="education" class="container-fluid bg-2 text-center">
         <h3 class="margin heading">Wykształcenie</h3>
      ...
      <div  id="skills" class="container-fluid bg-3 text-center">
         <h3 class="margin heading">Umiejętności</h3>
         <br>
         <div class="row">
      ...
      <div  id="hobby" class="container-fluid bg-4 text-center">
         <h3 class="margin heading">Zainteresowania</h3>
         <div class="row">
